  ...
  <body>
    <header class="header">
      <nav class="nav">
        ...
        />
        <!-- <div class="nav__text" onclick="alert('HTML onclick')">Просто Банк</div> -->
    ...
    <section class="section" id="section--3">
      ...
      <div class="slider">
        ...
        <!-- <div class="slide">
          <img src="img/image-1.jpg" alt="Фото природы" />
        </div>
        <div class="slide">
          <img src="img/image-2.jpg" alt="Фото природы" />
        </div>
        <div class="slide">
          <img src="img/image-3.jpg" alt="Фото природы" />
        </div>
        <div class="slide">
          <img src="img/image-4.jpg" alt="Фото природы" />
        </div> -->
